...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p 8d96db3c-7c8b-4092-9090-19c003d0c540
```

> `8d96db3c-7c8b-4092-9090-19c003d0c540` is the password of the certificate, you can change it to any password you want.
